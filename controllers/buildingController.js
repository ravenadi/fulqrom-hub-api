/**
 * Building Controller
 * Handles business logic for building CRUD operations.
 * Migrated from routes/buildings.js as part of Phase 3 - Clean Architecture
 *
...
/**
 * List all buildings with filtering and pagination
 * GET /api/buildings
 */
const list = async (req, res) => {
  try {
    ...
    // Filter by is_active (backward compatibility with status/operational_status)
    ...
    console.error('Error in buildingController.list:', error);
    res.status(500).json({
      success: false,
...
const getById = async (req, res) => {
  try {
    ...
    console.error('Error in buildingController.getById:', error);
    res.status(500).json({
      success: false,
...
/**
 * Get building statistics (counts only, for performance)
...
const getStats = async (req, res) => {
  try {
    ...
    console.error('Error in buildingController.getStats:', error);
    res.status(500).json({
      success: false,
...
const create = async (req, res) => {
  try {
    ...
    console.error('Error in buildingController.create:', error);
    res.status(400).json({
      success: false,
...
const remove = async (req, res) => {
  try {
    ...
    console.error('Error in buildingController.remove:', error);
    res.status(500).json({
      success: false,
 ...
 * GET /api/buildings/summary/stats
 */
const getSummaryStats = async (req, res) => {
  try {
    ...
    console.error('Error in buildingController.getSummaryStats:', error);
    res.status(500).json({
      success: false,
      message: 'Error fetching building statistics',
      error: error.message
...
const getByCategory = async (req, res) => {
  try {
    ...
    console.error('Error in buildingController.getByCategory:', error);
    res.status(500).json({
      success: false,
